...
JENKINS_VERSION=$1
JENKINS_SHA=$(curl -sSL -u $USER:$PASSWORD https://repo-internal.cloudbees.com/com/cloudbees/jenkins/main/jenkins-enterprise-war/$JENKINS_VERSION/jenkins-enterprise-war-$JENKINS_VERSION.war.sha1)
...
docker build -t cloudbees/jenkins-enterprise:$JENKINS_VERSION .
